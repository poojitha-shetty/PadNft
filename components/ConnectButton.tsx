  ...
  return (
    <div className="flex justify-center">
      {isConnecting ? (
        <button
          type="button"
          className="flex justify-center items-center border-2 border-white-600 bg-black rounded-full px-4 py-2 w-10 cursor-not-allowed"
          disabled
        >
          <svg
        ...
        <button
          type="button"
          className="flex justify-center items-center space-x-2 border-2 border-green-600 hover:border-white bg-black rounded-full px-4 py-2 w-40"
