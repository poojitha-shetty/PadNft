    ...
    <>
      ...
      {active && account ? (
        <div className="space-y-4 mb-4">
          <div className="bg-black border border-4 border-t-red-600 border-r-red-600 border-b-red-600 border-l-red-700 rounded p-8 space-y-4">
            ...
            <div className="flex justify-center items-center space-x-4">
              <IconContext.Provider value={{ size: '1.5em' }}>
                ...
                <button
                  type="button"
                  className={
                    mintAmount === 30 ? 'text-red-600 cursor-default' : ''
                  }
              ...
              {!active || errMsg ? (
                ...
                <>
                  {isPending || isMinting ? (
                    ...
                    <button
                      type="button"
                      className={`rounded px-4 py-2 bg-red-600 hover:bg-red-800 font-bold w-40`}
                      onClick={claimNFTs}
                    >
                      Buy
                    </button>
        ...
        <div className="border-dashed border-4 border-black-200 rounded p-8">
          <ConnectButton />
        </div>
      )}
    </>
